                ...
                <div className='d-flex justify-content-around'>
                    <div className={`${styles.form}`}>
                        <div className={`${styles.error} text-center`}>
                            {
                                !error ? null : error == 404 ? <Toast error='Sorry we could not found your account' /> :
                                    error == 403 ? <Toast error='Worg Password' /> : <Toast error='Please provide a valid email address and password.' />
                                            ...
                                            <div className='form-group mt-3'>
                                                ...
                                                <div className='d-flex justify-content-between'>
                                                    ...
                                                    <Link href={'/forgetPassword'}>
                                                        <a className={`${styles.anchor} ms-1 text-decoration-none`}>
                                                            Forget Password ?
                                                        </a>
                                                    </Link>
                                                </div>
